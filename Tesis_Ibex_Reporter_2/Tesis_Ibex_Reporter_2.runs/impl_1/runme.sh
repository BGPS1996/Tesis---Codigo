...
HD_PWD='C:/Users/BGPS/Desktop/Tesis/Tesis/project/Tesis_Ibex_Reporter_2/Tesis_Ibex_Reporter_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_ibex_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zybo_ibex_top.tcl -notrace
