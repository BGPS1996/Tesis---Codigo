...
HD_PWD='C:/Users/BGPS/Desktop/Tesis/Tesis/project/Tesis_Ibex_Reporter_2/Tesis_Ibex_Reporter_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zybo_ibex_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zybo_ibex_top.tcl
