...
HD_PWD='C:/Users/BGPS/Desktop/Tesis/Tesis/project/Tesis_Ibex_Reporter_2/Tesis_Ibex_Reporter_2.runs/bram_instrucciones_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bram_instrucciones.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bram_instrucciones.tcl
