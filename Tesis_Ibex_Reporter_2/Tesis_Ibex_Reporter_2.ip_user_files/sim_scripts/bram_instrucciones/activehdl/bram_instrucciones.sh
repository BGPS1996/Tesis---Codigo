...
#                script (type 'bram_instrucciones.sh -help' for more information).
#
...
map_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="C:/Users/BGPS/Desktop/Tesis/Tesis/project/Tesis_Ibex_Reporter_2/Tesis_Ibex_Reporter_2.cache/compile_simlib/activehdl"
  fi
  if [[ ($lib_map_path != "") ]]; then
